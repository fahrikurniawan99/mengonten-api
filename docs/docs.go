...
const docTemplate = `{
    ...
    "paths": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.SuspendRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.WarnRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/admin/videos": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search by title/genre",
                        "name": "search",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Video list with pagination",
                        "schema": {
                            "$ref": "#/definitions/utils.Response"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.ResendVerificationRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.VerifyEmailRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/youtube/segments/{segment_id}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/routes.SubmitYouTubeRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Video submitted",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/utils.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/routes.YouTubeVideoResponse"
                                        }
                                    }
                                }
                            ]
